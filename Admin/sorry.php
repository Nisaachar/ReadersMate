...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    <!-- <h1>404</h1> -->
    <h3>LOST IN <span>SPACE</span> READERS MATE ?<br> Hmm, looks like you are not an Admin.</h3>
    ...
    <a href="login.php"><button class="denied__link">Try Your Luck</button></a>
    <a href="../index.php"><button class="denied__link">Go Home</button></a>
  </div>
</body>
<style>
